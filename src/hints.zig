...
pub const hints = struct {
    ...
    pub const accelerometer_as_joystick = "SDL_ACCELEROMETER_AS_JOYSTICK";
    ...
    ///    "1"       - allow topmost
    pub const allow_topmost = "SDL_ALLOW_TOPMOST";
    ...
    ///
    /// The value should be set before SDL is initialized.
    pub const android_block_on_pause_pauseaudio = "SDL_ANDROID_BLOCK_ON_PAUSE_PAUSEAUDIO";
    ...
    ///
    /// On targets where this is not supported, this hint does nothing.
    pub const audio_device_app_name = "SDL_AUDIO_DEVICE_APP_NAME";
    ...
    pub const force_raisewindow = "SDL_HINT_FORCE_RAISEWINDOW";
    ...
    pub const grab_keyboard = "SDL_GRAB_KEYBOARD";
    ...
    pub const ime_internal_editing = "SDL_IME_INTERNAL_EDITING";
    ...
    pub const ime_show_ui = "SDL_IME_SHOW_UI";
    ...
    ///
    pub const joystick_gamecube_rumble_brake = "SDL_JOYSTICK_GAMECUBE_RUMBLE_BRAKE";
    ...
    pub const joystick_hidapi_ps4_rumble = "SDL_JOYSTICK_HIDAPI_PS4_RUMBLE";
    ...
    pub const joystick_hidapi_ps5_rumble = "SDL_JOYSTICK_HIDAPI_PS5_RUMBLE";
    ...
    pub const linux_digital_hats = "SDL_LINUX_DIGITAL_HATS";
    ...
    pub const linux_hat_deadzones = "SDL_LINUX_HAT_DEADZONES";
    ...
    pub const linux_joystick_classic = "SDL_LINUX_JOYSTICK_CLASSIC";
    ...
    pub const linux_joystick_deadzones = "SDL_LINUX_JOYSTICK_DEADZONES";
    ...
    pub const mouse_relative_mode_warp = "SDL_MOUSE_RELATIVE_MODE_WARP";
    ...
    pub const pen_not_mouse = "SDL_HINT_PEN_NOT_MOUSE";
    ...
    pub const pen_delay_mouse_button = "SDL_HINT_PEN_DELAY_MOUSE_BUTTON";
    ...
    pub const orientations = "SDL_IOS_ORIENTATIONS";
    ...
    pub const qtwayland_content_orientation = "SDL_QTWAYLAND_CONTENT_ORIENTATION";
    ...
    pub const qtwayland_window_flags = "SDL_QTWAYLAND_WINDOW_FLAGS";
    ...
    pub const render_opengl_shaders = "SDL_RENDER_OPENGL_SHADERS";
    ...
    pub const render_scale_quality = "SDL_RENDER_SCALE_QUALITY";
    ...
    pub const ps2_dynamic_vsync = "SDL_PS2_DYNAMIC_VSYNC";
    ...
    /// SDL_CreateThread().
    pub const thread_stack_size = "SDL_THREAD_STACK_SIZE";
    ...
    pub const vita_touch_mouse_device = "SDL_HINT_VITA_TOUCH_MOUSE_DEVICE";
    ...
    /// fails.
    pub const video_egl_allow_getdisplay_fallback = "SDL_VIDEO_EGL_GETDISPLAY_FALLBACK";
    ...
    pub const video_external_context = "SDL_VIDEO_EXTERNAL_CONTEXT";
    ...
    ///  mode directly.
    pub const video_wayland_emulate_mouse_warp = "SDL_VIDEO_WAYLAND_EMULATE_MOUSE_WARP";
    ...
    ///
    pub const windows_force_mutex_critical_sections = "SDL_WINDOWS_FORCE_MUTEX_CRITICAL_SECTIONS";
    ...
    pub const windows_no_close_on_alt_f4 = "SDL_WINDOWS_NO_CLOSE_ON_ALT_F4";
    ...
    pub const winrt_handle_back_button = "SDL_WINRT_HANDLE_BACK_BUTTON";
    ...
    pub const winrt_privacy_policy_label = "SDL_WINRT_PRIVACY_POLICY_LABEL";
    ...
    pub const winrt_privacy_policy_url = "SDL_WINRT_PRIVACY_POLICY_URL";
    ...
    ///
    ///  This hint is available only if SDL_GDK_TEXTINPUT defined.
    pub const gdk_textinput_default = "SDL_GDK_TEXTINPUT_DEFAULT";
...
pub const HintPriority = enum(c_uint) {
    default,
    normal,
    override,
};
...
pub fn setHintWithPriority(name: [*:0]const u8, value: [*:0]const u8, priority: HintPriority) bool {
    return SDL_SetHintWithPriority(name, value, priority).toZig();
}
...
pub fn setHint(name: [*:0]const u8, value: [*:0]const u8) bool {
    return SDL_SetHint(name, value).toZig();
}
...
/// \returns SDL_TRUE if the hint was set, SDL_FALSE otherwise.
///
pub fn resetHint(name: [*:0]const u8) bool {
    return SDL_ResetHint(name).toZig();
}
...
///          hint does not exist.
///
pub fn getHintBoolean(name: [*:0]const u8, default_value: bool) bool {
    return SDL_GetHintBoolean(name, Bool.fromZig(default_value)).toZig();
}
...
///
pub fn addHintCallback(name: [*:0]const u8, callback: HintCallback, userdata: ?*anyopaque) Error!void {
    try internal.checkResult(SDL_AddHintCallback(name, callback, userdata));
}
...
extern fn SDL_AddHintCallback(name: [*:0]const u8, callback: HintCallback, userdata: ?*anyopaque) c_int;
extern fn SDL_DelHintCallback(name: [*:0]const u8, callback: HintCallback, userdata: ?*anyopaque) void;
